...
class Camera:
    ...
    def init_camera(self,fAperture=1.0, fFocusDist=5.0):
        self.set_Lens(fAperture, fFocusDist)
    ...
    def set_Lens(self, fAperture, fFocusDist):
        self.Lens = Thinlens(fAperture, fFocusDist)
...
class Thinlens(Lens):
    def __init__(self, fAperture = 1.0, fFocusDist=5.0) -> None:
        super().__init__()
